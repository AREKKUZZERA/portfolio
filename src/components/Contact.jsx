    ...
    <section id="contact" style={{ padding: '8rem 2.5rem 6rem', maxWidth: 1100, margin: '0 auto' }}>
      ...
      <div style={{ textAlign: 'center', marginBottom: '5rem' }}>
        ...
        <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap' }}>
          {/* Telegram */}
          <Parallax as="a" href="https://t.me/bvbvbvbvbvbvbvbvbvvbv" target="_blank" rel="noreferrer"
            className="btn-primary"
            x={14} y={10} z={18} rotate={2.4} scale={1.02}
          ...
          {/* GitHub */}
          <Parallax as="a" href="https://github.com/AREKKUZZERA" target="_blank" rel="noreferrer" className="btn-ghost"
            x={14} y={10} z={18} rotate={2.4} scale={1.02}
            style={{ fontSize: '0.82rem', padding: '0.9rem 2.2rem' }}
          >
            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
